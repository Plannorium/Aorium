...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "session" | "onboarding" | "file" | "analysisResult"
    ...
    model: {
      ...
      Onboarding: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.OnboardingFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.OnboardingAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
      ...
      AnalysisResult: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.AnalysisResultFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.AnalysisResultAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "password" | "profilePicture" | "name" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export interface Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    analysisResults<T extends User$analysisResultsArgs<ExtArgs> = {}>(args?: Subset<T, User$analysisResultsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$AnalysisResultPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  export type OnboardingMinAggregateOutputType = {
    ...
    industryChallenges: string | null
  }
  ...
  export type OnboardingOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "step" | "completed" | "businessName" | "businessType" | "businessSize" | "region" | "goals" | "uploadedFiles" | "competitors" | "targetAudience" | "industryChallenges" | "contentFocus" | "preferredPlatforms" | "contentKPIs", ExtArgs["result"]["onboarding"]>
  ...
  export type $OnboardingPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    scalars: $Extensions.GetPayloadResult<{
      ...
      region: string | null
      goals: string[]
      uploadedFiles: Prisma.JsonValue[]
      competitors: string | null
      targetAudience: string | null
      industryChallenges: string | null
      contentFocus: string[]
  ...
  export interface OnboardingDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Onboardings that matches the filter.
     * @param {OnboardingFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const onboarding = await prisma.onboarding.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: OnboardingFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Onboarding.
     * @param {OnboardingAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const onboarding = await prisma.onboarding.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: OnboardingAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface OnboardingFieldRefs {
    ...
    readonly businessName: FieldRef<"Onboarding", 'String'>
    readonly businessType: FieldRef<"Onboarding", 'String'>
    readonly businessSize: FieldRef<"Onboarding", 'String'>
    readonly region: FieldRef<"Onboarding", 'String'>
    readonly goals: FieldRef<"Onboarding", 'String[]'>
    readonly uploadedFiles: FieldRef<"Onboarding", 'Json[]'>
    readonly competitors: FieldRef<"Onboarding", 'String'>
    readonly targetAudience: FieldRef<"Onboarding", 'String'>
    readonly industryChallenges: FieldRef<"Onboarding", 'String'>
    readonly contentFocus: FieldRef<"Onboarding", 'String[]'>
    readonly preferredPlatforms: FieldRef<"Onboarding", 'String[]'>
    readonly contentKPIs: FieldRef<"Onboarding", 'String[]'>
  }
   ...
   * Onboarding findRaw
   */
  export type OnboardingFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * Onboarding aggregateRaw
   */
  export type OnboardingAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type FileOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "ownerId" | "filename" | "url" | "publicId" | "mime" | "size" | "section" | "uploadedAt", ExtArgs["result"]["file"]>
  ...
  export type AnalysisResultOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "task" | "result" | "context" | "createdAt", ExtArgs["result"]["analysisResult"]>
  ...
  export interface AnalysisResultDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more AnalysisResults that matches the filter.
     * @param {AnalysisResultFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const analysisResult = await prisma.analysisResult.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: AnalysisResultFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a AnalysisResult.
     * @param {AnalysisResultAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const analysisResult = await prisma.analysisResult.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: AnalysisResultAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface AnalysisResultFieldRefs {
    ...
    readonly task: FieldRef<"AnalysisResult", 'String'>
    readonly result: FieldRef<"AnalysisResult", 'String'>
    readonly context: FieldRef<"AnalysisResult", 'String'>
  ...
  /**
   * AnalysisResult findRaw
   */
  export type AnalysisResultFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * AnalysisResult aggregateRaw
   */
  export type AnalysisResultAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type OnboardingWhereInput = {
    ...
    businessName?: StringNullableFilter<"Onboarding"> | string | null
    businessType?: StringNullableFilter<"Onboarding"> | string | null
    businessSize?: StringNullableFilter<"Onboarding"> | string | null
    region?: StringNullableFilter<"Onboarding"> | string | null
    goals?: StringNullableListFilter<"Onboarding">
    uploadedFiles?: JsonNullableListFilter<"Onboarding">
    competitors?: StringNullableFilter<"Onboarding"> | string | null
    targetAudience?: StringNullableFilter<"Onboarding"> | string | null
    industryChallenges?: StringNullableFilter<"Onboarding"> | string | null
    contentFocus?: StringNullableListFilter<"Onboarding">
    preferredPlatforms?: StringNullableListFilter<"Onboarding">
    contentKPIs?: StringNullableListFilter<"Onboarding">
    user?: XOR<UserScalarRelationFilter, UserWhereInput>
  }
  ...
  export type OnboardingOrderByWithRelationInput = {
    ...
    industryChallenges?: SortOrder
    contentFocus?: SortOrder
    preferredPlatforms?: SortOrder
    contentKPIs?: SortOrder
    user?: UserOrderByWithRelationInput
  }
  ...
  export type OnboardingScalarWhereWithAggregatesInput = {
    ...
    businessName?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    businessType?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    businessSize?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    region?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    goals?: StringNullableListFilter<"Onboarding">
    uploadedFiles?: JsonNullableListFilter<"Onboarding">
    competitors?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    targetAudience?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    industryChallenges?: StringNullableWithAggregatesFilter<"Onboarding"> | string | null
    contentFocus?: StringNullableListFilter<"Onboarding">
    preferredPlatforms?: StringNullableListFilter<"Onboarding">
    contentKPIs?: StringNullableListFilter<"Onboarding">
  }
  ...
  export type AnalysisResultWhereInput = {
    ...
    task?: StringFilter<"AnalysisResult"> | string
    result?: StringFilter<"AnalysisResult"> | string
    context?: StringFilter<"AnalysisResult"> | string
  ...
  export type AnalysisResultScalarWhereWithAggregatesInput = {
    ...
    task?: StringWithAggregatesFilter<"AnalysisResult"> | string
    result?: StringWithAggregatesFilter<"AnalysisResult"> | string
    context?: StringWithAggregatesFilter<"AnalysisResult"> | string
  ...
  export type OnboardingCreateInput = {
    ...
    businessSize?: string | null
    region?: string | null
    goals?: OnboardingCreategoalsInput | string[]
    uploadedFiles?: OnboardingCreateuploadedFilesInput | InputJsonValue[]
    competitors?: string | null
    targetAudience?: string | null
    industryChallenges?: string | null
    contentFocus?: OnboardingCreatecontentFocusInput | string[]
    preferredPlatforms?: OnboardingCreatepreferredPlatformsInput | string[]
    contentKPIs?: OnboardingCreatecontentKPIsInput | string[]
  ...
  export type OnboardingUpdateInput = {
    ...
    businessSize?: NullableStringFieldUpdateOperationsInput | string | null
    region?: NullableStringFieldUpdateOperationsInput | string | null
    goals?: OnboardingUpdategoalsInput | string[]
    uploadedFiles?: OnboardingUpdateuploadedFilesInput | InputJsonValue[]
    ...
    industryChallenges?: NullableStringFieldUpdateOperationsInput | string | null
    contentFocus?: OnboardingUpdatecontentFocusInput | string[]
    preferredPlatforms?: OnboardingUpdatepreferredPlatformsInput | string[]
    contentKPIs?: OnboardingUpdatecontentKPIsInput | string[]
  ...
  export type OnboardingCreateuploadedFilesInput = {
    set: InputJsonValue[]
  }

  export type OnboardingCreatecontentFocusInput = {
    set: string[]
  }

  export type OnboardingCreatepreferredPlatformsInput = {
    set: string[]
  }

  export type OnboardingCreatecontentKPIsInput = {
    set: string[]
  }
  ...
  export type OnboardingUpdateuploadedFilesInput = {
    set?: InputJsonValue[]
    push?: InputJsonValue | InputJsonValue[]
  }

  export type OnboardingUpdatecontentFocusInput = {
    set?: string[]
    push?: string | string[]
  }

  export type OnboardingUpdatepreferredPlatformsInput = {
    set?: string[]
    push?: string | string[]
  }

  export type OnboardingUpdatecontentKPIsInput = {
    set?: string[]
    push?: string | string[]
  }
